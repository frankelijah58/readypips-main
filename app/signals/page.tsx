...
import { CheckCircle, Lock, ShieldCheck, Zap, Globe, MessageCircle, BarChart3, PlusCircle, Send, Clock, Sparkles, Star } from 'lucide-react';
              ...
              <div className="flex flex-col items-center gap-6 pt-4">
                <div className="flex p-1.5 bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl w-fit">
                  {['whop', 'binance', 'mpesa'].map((p) => (
                    <button
                      key={p}
                      onClick={() => setSelectedProvider(p as "whop" | "binance" | "mpesa")}
