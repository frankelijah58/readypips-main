...
export default function PaymentProviderModal({
  ...
  type="button"
  disabled
  className="group relative flex items-center justify-between rounded-xl border border-yellow-200 p-4 text-left opacity-80 cursor-not-allowed bg-yellow-50/30 dark:bg-yellow-950/10"
>
  <div className="flex items-center gap-4">
